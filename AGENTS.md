# AGENTS.md — GloryWellNic Landing Page

> Hand this file to Codex. It contains every design decision, animation spec, component pattern, and implementation detail needed to build the GloryWellNic landing page exactly as designed.
...
*End of AGENTS.md — This file contains the complete design system for GloryWellNic landing page v1.0*
